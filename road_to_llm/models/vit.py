...
class ViT(nn.Module):
    def __init__(self, *, image_size, patch_size, num_classes, dim, depth, heads, mlp_dim, pool="cls", channels=3, dim_head=64, dropout=0., emb_dropout=0.):
        ...
        patch_height, patch_width = patch_size if isinstance(image_size, tuple) else (patch_size, patch_size)
        ...
        self.pos_embedding = nn.Parameter(Tensor.randn(1, num_patches + 1, dim))
        self.cls_token = nn.Parameter(Tensor.randn(1, 1, dim))
    ...
    def __call__(self, img):
        ...
        x = Tensor.cat((cls_tokens, x), dim=1)
